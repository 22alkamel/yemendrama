...
"[project]/app/plays/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
        ...
        "Plays.useEffect": ()=>{
            async function fetchData() {
                try {
                    ...
                    const playsData = Array.isArray(data.data) ? data.data.filter({
                        "Plays.useEffect.fetchData": (c)=>c.type === "play"
                    }["Plays.useEffect.fetchData"]) : [];
                    setContents(playsData);
                    // استخراج التصنيفات من المسرحيات
                    const allCategories = new Set();
                    playsData.forEach({
                        "Plays.useEffect.fetchData": (play)=>{
                            play.categories?.forEach({
                                "Plays.useEffect.fetchData": (cat)=>allCategories.add(cat.name)
                            }["Plays.useEffect.fetchData"]);
                        }
                    }["Plays.useEffect.fetchData"]);
                    setGenres([
...
_s(Plays, "6dShv+qW4Rli51lZsCxJF52zlw8=");
_c = Plays;
var _c;
__turbopack_context__.k.register(_c, "Plays");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=_a0ef3730._.js.map