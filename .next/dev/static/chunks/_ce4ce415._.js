...
"[project]/app/kids/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function Kids() {
        ...
        "Kids.useEffect": ()=>{
            async function fetchData() {
                try {
                    ...
                    const kidsData = Array.isArray(data.data) ? data.data.filter({
                        "Kids.useEffect.fetchData": (c)=>c.type === "kids"
                    }["Kids.useEffect.fetchData"]) : [];
                    setContents(kidsData);
                    // بناء قائمة الأنواع (categories) من البيانات المأخوذة
                    const allCategories = new Set();
                    kidsData.forEach({
                        "Kids.useEffect.fetchData": (item)=>{
                            item.categories?.forEach({
                                "Kids.useEffect.fetchData": (cat)=>allCategories.add(cat.name)
                            }["Kids.useEffect.fetchData"]);
                        }
                    }["Kids.useEffect.fetchData"]);
                    setGenres([
    ...
    const filteredKids = contents.filter((item)=>selectedGenre === "الكل" || item.categories?.some((cat)=>cat.name === selectedGenre));
    const sortedKids = [
        ...filteredKids
    ].sort((a, b)=>{
    ...
    if (loading) return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: "جاري تحميل محتوى الأطفال..."
    }, void 0, false, {
...
_s(Kids, "6dShv+qW4Rli51lZsCxJF52zlw8=");
_c = Kids;
var _c;
__turbopack_context__.k.register(_c, "Kids");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=_ce4ce415._.js.map