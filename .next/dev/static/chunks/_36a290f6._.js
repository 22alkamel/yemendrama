        ...
        "Movies.useEffect": ()=>{
            async function fetchData() {
                try {
                    ...
                    const moviesData = Array.isArray(data.data) ? data.data.filter({
                        "Movies.useEffect.fetchData": (c)=>c.type === "movie"
                    }["Movies.useEffect.fetchData"]) : [];
                    setContents(moviesData);
                    // استخراج التصنيفات من الأفلام
                    const allCategories = new Set();
                    moviesData.forEach({
                        "Movies.useEffect.fetchData": (item)=>{
                            item.categories?.forEach({
                                "Movies.useEffect.fetchData": (cat)=>allCategories.add(cat.name)
                            }["Movies.useEffect.fetchData"]);
                        }
                    }["Movies.useEffect.fetchData"]);
                    setGenres([
...
_s(Movies, "6dShv+qW4Rli51lZsCxJF52zlw8=");
_c = Movies;
var _c;
...
//# sourceMappingURL=_36a290f6._.js.map