...
"[project]/app/admin/newscategories/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$newsCategory$2e$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/services/newsCategory.service.ts [app-client] (ecmascript)"); // تأكد أن هذا الـ service يحتوي على الـ API الصحيح
;
var _s = __turbopack_context__.k.signature();
"use client";
;
...
function AdminNewsCategories() {
    ...
    const handleCreateOrUpdate = async ()=>{
        ...
        try {
            if (editingId) {
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$newsCategory$2e$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["updateCategory"])(editingId, {
                    name
                });
                setEditingId(null);
            } else {
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$newsCategory$2e$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createCategory"])({
                    name
                });
            }
            setName("");
    ...
    const handleDelete = async (id)=>{
        ...
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$newsCategory$2e$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["deleteCategory"])(id);
            fetchCategories();
        } catch (err) {
            console.error(err);
...
_s(AdminNewsCategories, "duU73CfIIeqim3oHaSWoKdhYD/g=");
_c = AdminNewsCategories;
var _c;
__turbopack_context__.k.register(_c, "AdminNewsCategories");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=_e23e5426._.js.map