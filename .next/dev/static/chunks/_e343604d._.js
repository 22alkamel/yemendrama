...
function Podcasts() {
        ...
        "Podcasts.useEffect": ()=>{
            async function fetchData() {
                try {
                    ...
                    const podcastsData = Array.isArray(data.data) ? data.data.filter({
                        "Podcasts.useEffect.fetchData": (c)=>c.type === "podcast"
                    }["Podcasts.useEffect.fetchData"]) : [];
                    setContents(podcastsData);
                    // استخراج التصنيفات من البودكاست
                    const allCategories = new Set();
                    podcastsData.forEach({
                        "Podcasts.useEffect.fetchData": (item)=>{
                            item.categories?.forEach({
                                "Podcasts.useEffect.fetchData": (cat)=>allCategories.add(cat.name)
                            }["Podcasts.useEffect.fetchData"]);
                        }
                    }["Podcasts.useEffect.fetchData"]);
                    setGenres([
    ...
    const filteredPodcasts = contents.filter((item)=>selectedGenre === "الكل" || item.categories?.some((cat)=>cat.name === selectedGenre));
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: sortedPodcasts.map((item)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$MovieCard$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                                movie: {
                                    id: item.uuid,
                                    title: item.title,
                                    description: item.description ?? "",
                                    image: `http://localhost:8000${item.poster_image ?? item.card_image}`,
                                    cardimg: `http://localhost:8000${item.card_image ?? item.poster_image}`,
...
_s(Podcasts, "6dShv+qW4Rli51lZsCxJF52zlw8=");
_c = Podcasts;
var _c;
...
//# sourceMappingURL=_e343604d._.js.map