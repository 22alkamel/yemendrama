        ...
        "Programs.useEffect": ()=>{
            async function fetchData() {
                try {
                    ...
                    const programsData = Array.isArray(data.data) ? data.data.filter({
                        "Programs.useEffect.fetchData": (c)=>c.type === "program"
                    }["Programs.useEffect.fetchData"]) : [];
                    setContents(programsData);
                    // استخراج التصنيفات من البرامج
                    const allCategories = new Set();
                    programsData.forEach({
                        "Programs.useEffect.fetchData": (item)=>{
                            item.categories?.forEach({
                                "Programs.useEffect.fetchData": (cat)=>allCategories.add(cat.name)
                            }["Programs.useEffect.fetchData"]);
                        }
                    }["Programs.useEffect.fetchData"]);
                    setGenres([
...
_s(Programs, "6dShv+qW4Rli51lZsCxJF52zlw8=");
_c = Programs;
var _c;
...
//# sourceMappingURL=_f62b8bd8._.js.map