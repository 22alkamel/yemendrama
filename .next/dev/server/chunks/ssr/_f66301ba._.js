...
"[project]/app/plays/page.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function Plays() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        async function fetchData() {
            try {
                ...
                const playsData = Array.isArray(data.data) ? data.data.filter((c)=>c.type === "play") : [];
                setContents(playsData);
                // استخراج التصنيفات من المسرحيات
                const allCategories = new Set();
                playsData.forEach((play)=>{
                    play.categories?.forEach((cat)=>allCategories.add(cat.name));
                });
                setGenres([
                    "الكل",
    ...
    const filteredPlays = contents.filter((play)=>selectedGenre === "الكل" || play.categories?.some((cat)=>cat.name === selectedGenre));
    const sortedPlays = [
        ...filteredPlays
    ].sort((a, b)=>{
    ...
    if (loading) return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: "جاري تحميل المسرحيات..."
    }, void 0, false, {
        fileName: "[project]/app/plays/page.tsx",
        lineNumber: 56,
        columnNumber: 7
    }, this);
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
//# sourceMappingURL=_f66301ba._.js.map