...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/api.ts [app-ssr] (ecmascript)"); // نفس axios اللي تستخدمه مع التوكن
;
...
function Series() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        async function fetchData() {
            try {
                const data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$content$2e$service$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getPublishedContents"])();
                const seriesData = Array.isArray(data.data) ? data.data.filter((c)=>c.type === "series") : [];
                setContents(seriesData);
                // استخراج التصنيفات من المسلسلات
                const allCategories = new Set();
                seriesData.forEach((show)=>{
                    show.categories?.forEach((cat)=>allCategories.add(cat.name));
                });
                setGenres([
                    "الكل",
    ...
    const filteredSeries = contents.filter((show)=>selectedGenre === "الكل" || show.categories?.some((cat)=>cat.name === selectedGenre));
    const sortedSeries = [
        ...filteredSeries
    ].sort((a, b)=>{
        if (sortBy === "الأحدث") return (parseInt(b.year) || 0) - (parseInt(a.year) || 0);
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: sortedSeries.map((show)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$series$2f$SeriesCard$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"], {
                                series: {
                                    ...
                                    image: `http://localhost:8000${show.poster_image ?? show.card_image}`,
                                    cardimg: `http://localhost:8000${show.card_image ?? show.poster_image}`,
                                    rating: show.rating ?? 0,
                                    year: show.year ?? 0,
                                    genre: show.categories?.map((cat)=>cat.name).join(", ") ?? "",
                                    crew: {
                                        producer: {
                                            name: "",
                                            logo: ""
...
//# sourceMappingURL=_3e260171._.js.map