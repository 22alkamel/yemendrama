...
function Programs() {
    ...
    const filteredMovies = __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$programs$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["programs"].filter((program)=>selectedGenre === 'الكل' || program.genre === selectedGenre);
    const sortedMovies = [
        ...filteredMovies
    ].sort((a, b)=>{
...
//# sourceMappingURL=_3681dc7e._.js.map