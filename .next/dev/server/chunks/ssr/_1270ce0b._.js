...
function Movies() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        async function fetchData() {
            try {
                ...
                const moviesData = Array.isArray(data.data) ? data.data.filter((c)=>c.type === "movie") : [];
    ...
    const filteredMovies = contents.filter((movie)=>selectedGenre === "الكل" || movie.categories?.some((cat)=>cat.name === selectedGenre));
    const sortedMovies = [
        ...filteredMovies
    ].sort((a, b)=>{
...
//# sourceMappingURL=_1270ce0b._.js.map